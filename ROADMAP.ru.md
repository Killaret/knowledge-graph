...
- [ ] **Гибридная 3D-раскладка через graph-service**  
  *Серверный расчёт начальных позиций узлов для больших графов. Уменьшение времени холодного старта 3D-режима. Клиентская физика остаётся активной после загрузки. Цель: v2.1.*
