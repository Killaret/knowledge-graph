...
func (m *mockLinkRepoForAnalytics) FindByID(ctx context.Context, id uuid.UUID) (*link.Link, error) { return nil, nil }
func (m *mockLinkRepoForAnalytics) FindBySource(ctx context.Context, sourceID uuid.UUID) ([]*link.Link, error) { return nil, nil }
func (m *mockLinkRepoForAnalytics) FindByTarget(ctx context.Context, targetID uuid.UUID) ([]*link.Link, error) { return nil, nil }
func (m *mockLinkRepoForAnalytics) Delete(ctx context.Context, id uuid.UUID) error           { return nil }
func (m *mockLinkRepoForAnalytics) DeleteBySource(ctx context.Context, sourceID uuid.UUID) error { return nil }
func (m *mockLinkRepoForAnalytics) List(ctx context.Context) ([]*link.Link, error)            { return m.links, nil }
func (m *mockLinkRepoForAnalytics) FindAll(ctx context.Context) ([]*link.Link, error)         { return m.links, nil }
func (m *mockLinkRepoForAnalytics) FindAllPaginated(ctx context.Context, limit, offset int) ([]*link.Link, int64, error) { return m.links, int64(len(m.links)), nil }
...
func (m *mockNoteRepoForAnalytics) DeleteBatch(ctx context.Context, ids []uuid.UUID) error           { return nil }
func (m *mockNoteRepoForAnalytics) Restore(ctx context.Context, id uuid.UUID) error                 { return nil }
func (m *mockNoteRepoForAnalytics) List(ctx context.Context, userID uuid.UUID, limit, offset int) ([]*note.Note, int64, error) { return nil, 0, nil }
func (m *mockNoteRepoForAnalytics) Search(ctx context.Context, userID uuid.UUID, query string, limit, offset int) ([]*note.Note, int64, error) { return nil, 0, nil }
func (m *mockNoteRepoForAnalytics) FindAll(ctx context.Context) ([]*note.Note, error) { return nil, nil }
func (m *mockNoteRepoForAnalytics) FindAllPaginated(ctx context.Context, userID uuid.UUID, limit, offset int) ([]*note.Note, int64, error) { return nil, 0, nil }
