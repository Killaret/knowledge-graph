...
func setupRouter(
	...
	v1 := r.Group("/api/v1")
	{
		...
		v1.POST("/notes/batch/create", writeLimiter, noteHandler.CreateBatch)
		v1.POST("/notes/batch/delete", writeLimiter, noteHandler.DeleteBatch)
		...
		v1.POST("/import/batch", writeLimiter, noteHandler.ImportBatch)
