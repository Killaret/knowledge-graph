...
| 🔴 Critical | Интеграционные тесты | Исправить циклический импорт, ошибки типов, конструкторы handler'ов (2026-07-23) | ✅ Готово |
...
| 🟢 Low | Мягкое внедрение FSD | Выделить shared/, entities/model, настроить алиасы, создать SidebarWidget, обновить импорты (2026-07-23) | ✅ Готово |
