...
- [Yandex.Disk Backup Setup (detailed)](../archive/YANDEX_DISK_BACKUP.md) — detailed Yandex.Disk configuration guide
- [Cloud Backup Setup](../archive/CLOUD_BACKUP_SETUP.md) — general cloud backup information
- [System Configuration](CONFIGURATION_EN.md) — complete configuration guide
- [Architecture](../architecture/ARCHITECTURE_SUMMARY.md) — backup system architecture
...
2. Review [docs/archive/YANDEX_DISK_BACKUP.md](../archive/YANDEX_DISK_BACKUP.md)
3. Check system logs
