...
> `docs/agents/MANUAL_TEST_FEEDBACK.md` (Cockpit §6) for the implementation summary
...
2. If something fails, add an entry to `docs/agents/MANUAL_TEST_FEEDBACK.md` under
