...
**Comprehensive testing commands for AI agents and developers.** The narrative guide is
[`TESTING.md`](TESTING.md); the project-wide command list is [`COMMANDS.md`](../../COMMANDS.md).
