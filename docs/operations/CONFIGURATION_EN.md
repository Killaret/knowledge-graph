...
**For detailed backup setup guide, see:** [`docs/operations/BACKUP.md`](BACKUP.md)
...
See also: [RECOMMENDATION_ARCHITECTURE.md](../architecture/RECOMMENDATION_ARCHITECTURE.md#migration-to-pure-precomputed-scores)
