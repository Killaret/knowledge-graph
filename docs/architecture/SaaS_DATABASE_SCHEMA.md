...
See [ADR 008: Data Migration Plan](./decisions/008-data-migration-plan.md) for:
...
- [ADR 004: Soft Delete Strategy](./decisions/004-soft-delete-strategy.md)
- [ADR 006: RBAC System](./decisions/006-rbac-system.md)
- [ADR 010: Audit Log Storage](./decisions/010-audit-log-storage-mongodb.md)
- [ADR 011: Drafts Autosave](./decisions/011-drafts-autosave-mongodb.md)
