...
The original 3D sources were snapshotted in `docs/archive/3d/` before the refactor. New code follows Svelte 5 runes and current FSD/Atomic Design boundaries, using the archive only as a reference.
