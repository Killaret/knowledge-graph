# Пересборка и тестирование Async Tasks

Этот документ содержит инструкции для пересборки проекта Knowledge Graph и проверки обработки асинхронных задач.
...
# Запустить полный скрипт (пересборка + тестирование)
