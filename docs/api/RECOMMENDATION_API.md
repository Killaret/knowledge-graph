...
> Canonical reference for all environment variables: [`CONFIGURATION_EN.md`](../operations/CONFIGURATION_EN.md). The subset below is the recommendation-specific config.
