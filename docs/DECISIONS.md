...
| 24 | 2026-09-12 | `DEPENDABOT-25`: PR #25 (`yake` 0.7.3) **не мержится**; `yake` остаётся 0.4.8; выбран путь замены на `keybert` (MIT) с лемматизацией | лицензия 0.7.3 фактически AGPL; риск copyleft | [`tasks/DEPENDABOT-25-yake-license.md`](tasks/DEPENDABOT-25-yake-license.md), [`tasks/YAKE-REPLACE-KEYBERT-LEMMATIZATION.md`](tasks/YAKE-REPLACE-KEYBERT-LEMMATIZATION.md) |
