...
- Документация: `docs/archive/MANUAL_TEST_CHECKLISTS_RU.md` — добавлен раздел валидации
- Документация: `docs/operations/MANUAL_TEST_CHECKLIST_MINIMAL.md` — добавлены проверки валидации
