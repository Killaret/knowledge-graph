...
**Этот отчёт устарел** — полная информация теперь в [`../CHANGELOG_EN.md`](../CHANGELOG_EN.md).
...
| Документ | Описание |
|----------|----------|
| [**`../CHANGELOG_EN.md`**](../CHANGELOG_EN.md) | Полная история изменений v1.0.0 |
| [**`../FRONTEND_ARCHITECTURE_EN.md`**](../FRONTEND_ARCHITECTURE_EN.md) | Актуальная архитектура фронтенда |
...
См. [`./README.md`](./README.md) для полного списка архивированных документов.
