...
| `docs/archive/MANUAL_TEST_CHECKLISTS_RU.md` | ✅ Updated | Enhanced with new canvas features |
| `docs/operations/TESTING.md` | ✅ Current | General testing guidelines |
...
**Location:** `docs/archive/MANUAL_TEST_CHECKLISTS_RU.md`
...
**Updates to `docs/archive/MANUAL_TEST_CHECKLISTS_RU.md`:**
