...
> Current direction: [`../ROADMAP.md`](../../ROADMAP.md). Detailed plans: [`BACKLOG.md`](../product/BACKLOG.md).
...
- [Recommendation System Architecture](../architecture/RECOMMENDATION_ARCHITECTURE.md)
- [Obsidian Import Specification](../product/OBSIDIAN_IMPORT_SPEC.md) (to be created)
- [SaaS Database Schema](../architecture/SaaS_DATABASE_SCHEMA.md)
