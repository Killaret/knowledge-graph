...
> **Пометка 2026-09-21 (ревью).** Ниже сказано «10 типов» и «без `moon`» — это до
> NOTE-TYPE-TAXONOMY (13.09): решением владельца `moon` пользовательский, UI-типов
> **одиннадцать**. Критерии читать с этой поправкой. Разбор:
> [`IMP-3-review-findings.md`](IMP-3-review-findings.md).
