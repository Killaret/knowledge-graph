...
- [Docker Deployment Guide](../operations/DOCKER.md)
...
- [Auto Link Creation Plan](../archive/AUTO_LINK_CREATION_PLAN.md)
...
- **Implementation sketch:** update `celestial-body.ts` (per-type description/example fields), extend i18n keys, add hints to `TypeSelector.svelte`; document the final mapping in `docs/product/CELESTIAL_BODY_SEMANTICS.md`.
