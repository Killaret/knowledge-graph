...
**Priority:** 🟢 Low (после архива и гигиены)
**Status:** 💡 Idea
**Description:** Пассивная геймификация гигиены знаний через персонифицированных стражей кластеров.
...
- **Зависимости:** Archive & Note Hygiene (фаза 15), NLP-сервис для будущей авто-генерации имён.
