...
- A mutation that stays green on the real path is a finding about the code: ask whether the mutated line should change the result — if it should, that is the defect; do not trade it for a different mutation.
