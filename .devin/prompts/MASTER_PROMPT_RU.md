...
> **Примечание:** Авторитетная версия этого промпта — `MASTER_PROMPT.md` на английском. В случае расхождения приоритет имеют `.windsurfrules` и `MASTER_PROMPT.md`.
...
- Авторитетная документация — на английском; русский перевод может поддерживаться параллельно.
