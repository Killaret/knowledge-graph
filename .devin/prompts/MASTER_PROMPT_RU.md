...
Противовес: **мутация, зелёная на реальном пути, — находка о коде.** Если изменённая строка исполняется, спросите, должно ли её изменение менять результат. Если должно — это и есть дефект: сообщите о нём, а не меняйте мутацию на другую. Мутация холостая, только если строка действительно ни за что не отвечает (лишняя, косметическая); скажите, какой это случай и почему.
