...
waiting for navigation until "load"
  navigated to "http://localhost:5173/notes/new?title=Playwright+Test&content=Automated+content"
============================================================
```
...
```yaml
- generic [ref=e2]:
  - heading "New Note" [level=1] [ref=e3]
  - generic [ref=e4]:
    - textbox "Title" [ref=e5]
    - textbox "Content (supports [[wiki links]])" [ref=e6]
    - button "Create" [ref=e7]
```
