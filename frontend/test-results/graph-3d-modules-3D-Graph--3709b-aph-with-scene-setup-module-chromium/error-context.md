...
- Name: graph-3d-modules.spec.ts >> 3D Graph - Modular Architecture >> should render 3D graph with scene setup module
- Location: tests\graph-3d-modules.spec.ts:16:3
