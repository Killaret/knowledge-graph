...
```
TypeError: notesData is not iterable
```
...
- generic [ref=e3]:
  ...
  - main [ref=e13]:
    - generic [ref=e16]:
      - generic [ref=e17]: ⭐
      - heading "Одинокая звезда" [level=1] [ref=e18]
      - paragraph [ref=e19]: У вас есть заметки, но связей пока нет. Выберите заметку, чтобы увидеть её связи.
      - generic [ref=e20]:
        - button "Все заметки" [ref=e21] [cursor=pointer]:
          - img [ref=e22]
          - text: Все заметки
        - button "Новая заметка" [ref=e23] [cursor=pointer]:
          - img [ref=e24]
          - text: Новая заметка
  - navigation "Main navigation":
    - button "Новая звезда" [ref=e25] [cursor=pointer]:
      - img [ref=e26]
