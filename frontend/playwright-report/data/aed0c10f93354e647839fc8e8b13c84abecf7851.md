...
Call log:
  - waiting for locator('.modal, [role="dialog"]') to be visible
...
- generic [ref=e3]:
  - generic [ref=e4]:
    - generic [ref=e5]:
      - button "Graph View" [ref=e6] [cursor=pointer]:
        - img [ref=e7]
      - button "List View" [ref=e17] [cursor=pointer]:
        - img [ref=e18]
    - generic [ref=e19]:
      - textbox "Search notes..." [ref=e20]
      - button [ref=e21] [cursor=pointer]:
        - img [ref=e22]
    - button "Menu" [ref=e26] [cursor=pointer]:
      - img [ref=e27]
    - button "Create new note" [active] [ref=e28] [cursor=pointer]:
      - img [ref=e29]
  - paragraph [ref=e33]: Loading notes...
```
