...
- Name: graph-3d.spec.ts >> Graph Visualization >> should display performance mode or fallback indicator
- Location: tests\graph-3d.spec.ts:89:3
...
Locator: locator('.graph-3d-container, .graph-2d, .graph-wrapper, .error-overlay').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.graph-3d-container, .graph-2d, .graph-wrapper, .error-overlay').first()
