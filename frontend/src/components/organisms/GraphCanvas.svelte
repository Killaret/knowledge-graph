<script lang="ts">
  ...
  import { createNoteFormState, type NoteFormState } from "$features/graph-forms/note-form";
  import { createLinkFormState, type LinkFormState } from "$features/graph-forms/link-form";
