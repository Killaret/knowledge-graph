...
export const en: Record<string, string> = {
  ...
  "cockpit.noteDetails.quality.empty": "empty",
  "cockpit.noteDetails.quality.mojibake": "broken encoding",
  "cockpit.noteDetails.quality.improve": "Re-assess",
  "cockpit.noteDetails.quality.refetch": "Re-fetch page",
  "cockpit.noteDetails.quality.restore": "Restore previous",
  "cockpit.noteDetails.quality.refetchApply": "Replace",
  "cockpit.noteDetails.quality.refetchCancel": "Cancel",
  "cockpit.noteDetails.quality.previewTitle": "New version: {{title}}",
  "cockpit.noteDetails.quality.previewLength": "{{current}} → {{next}} characters",
  "cockpit.noteDetails.quality.error": "Quality action failed.",
  "cockpit.noteDetails.quality.refetchError": "Failed to fetch the source page.",
  // Modal
...
export const ru: Record<string, string> = {
  ...
  "cockpit.noteDetails.quality.empty": "пустая",
  "cockpit.noteDetails.quality.mojibake": "битая кодировка",
  "cockpit.noteDetails.quality.improve": "Доработать",
  "cockpit.noteDetails.quality.refetch": "Перезабрать страницу",
  "cockpit.noteDetails.quality.restore": "Вернуть как было",
  "cockpit.noteDetails.quality.refetchApply": "Заменить",
  "cockpit.noteDetails.quality.refetchCancel": "Отмена",
  "cockpit.noteDetails.quality.previewTitle": "Новая версия: {{title}}",
  "cockpit.noteDetails.quality.previewLength": "{{current}} → {{next}} знаков",
  "cockpit.noteDetails.quality.error": "Не удалось выполнить действие качества.",
  "cockpit.noteDetails.quality.refetchError": "Не удалось получить страницу-источник.",
  // Modal
