...
export const en: Record<string, string> = {
  ...
  "note.linkWeight": "Link strength: {{weight}}",
  "note.linkWeightHint": "The bar shows how strongly the notes are connected",
...
export const ru: Record<string, string> = {
  ...
  "note.linkWeight": "Сила связи: {{weight}}",
  "note.linkWeightHint": "Полоска показывает, насколько тесно связаны заметки",
