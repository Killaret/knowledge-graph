...
{#if fogWarning}
  ...
  <div
    class="fog-warning"
    style="position: absolute; top: 56px; left: 50%; transform: translateX(-50%); background: {isDanger
      ? 'rgba(185, 28, 28, 0.92)'
      : 'rgba(29, 78, 216, 0.92)'}; border: 1px solid {isDanger
      ? 'rgba(255, 120, 120, 0.5)'
      : 'rgba(96, 165, 250, 0.5)'}; border-radius: 8px; padding: 8px 14px; color: white; z-index: 200; font-size: 13px; font-weight: 600; box-shadow: 0 4px 20px rgba(0,0,0,0.5); pointer-events: none;"
  >
